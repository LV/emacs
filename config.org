...
#+BEGIN_SRC emacs-lisp
  ...
  (with-eval-after-load 'evil
    ;; Define custom Ex commands for Org source editing
    (evil-ex-define-cmd "w[rite]" 'lv/org-edit-src-save-only)  ; `:w` saves without exiting
    (evil-ex-define-cmd "wq"      'lv/org-edit-src-exit-save)  ; `:wq` saves and exits
    (evil-ex-define-cmd "q[uit]"  'lv/org-edit-src-abort))     ; `:q` aborts without saving
#+END_SRC
