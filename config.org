...
#+begin_src emacs-lisp
  (defun lv/load-config-file (file)
    "Load a config file from the =modules/= directory."
    (org-babel-load-file
     (expand-file-name
      (concat user-emacs-directory "modules/" file))))
#+end_src

#+begin_src emacs-lisp
  (lv/load-config-file "eshell.org")
  (lv/load-config-file "org.org")
  (lv/load-config-file "projectile.org")
#+end_src
