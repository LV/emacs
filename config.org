...
#+begin_src emacs-lisp
  (defun lv/org-capture--fleeting-target ()
    ...
    (let ((fleeting-path (expand-file-name (format-time-string "%Y%m%d%H%M%S-%s.org") (concat org-roam-directory "/zk/fleeting/"))))
...
#+begin_src emacs-lisp
  (lv/leader-keys
    ...
    "ocd" '(org-roam-dailies-capture-today :which-key "daily")
    "ocf" '(lv/capture-fleeting-note       :which-key "fleeting")
