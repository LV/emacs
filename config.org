...
#+begin_src emacs-lisp
  ...
  ; TODO: Remove this check if you're launching in terminal mode
#+end_src
...
#+begin_src emacs-lisp
  (use-package ivy
    ...
    (setq ivy-re-builders-alist
          '((t . ivy--regex-plus))) ; Enable fuzzy search globally ; TODO: Un-fuzzy swiper, you already have `SPC f g` for ripgrep withing a file with covers this use-case
          ; '((t . ivy--regex-fuzzy))) ; Disable fuzzy search globally
    (ivy-mode 1))
#+end_src
...
Add ~flycheck~, does real-time syntax checking
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (defun lv/capture-fleeting-note ()
...
#+begin_src emacs-lisp
  (lv/leader-keys
    ...
    "of"  '(lv/capture-fleeting-note       :which-key "create fleeting note")
