...
* Modules
** All The Icons
Enables icons via specialized fonts
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (add-hook 'org-mode-hook #'lv/add-org-templates))
#+END_SRC

*** Templates
Add code block templates

#+BEGIN_SRC emacs-lisp
  (defun lv/add-org-templates ()
    "Add custom structure templates for Org mode."
