...
#+begin_src emacs-lisp
  ...
  ; FIXME: ~dirvish~ is not showing the current state of the directory! If you create a new directory or rename files, you won't see this in ~dirvish~ unless you quit and restart Emacs
#+end_src
