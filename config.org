...
#+BEGIN_SRC emacs-lisp
  ...
  (let* ((variable-tuple
    ...
    (custom-theme-set-faces
     'user
     ;; Org headings with EtBembo
     `(org-level-1          ((t (,@variable-tuple :weight bold :height 1.75))))
     `(org-level-2          ((t (,@variable-tuple :weight bold :height 1.5))))
     `(org-level-3          ((t (,@variable-tuple :weight bold :height 1.25))))
     `(org-level-4          ((t (,@variable-tuple :weight bold :height 1.1))))
     `(org-level-5          ((t (,@variable-tuple :weight bold))))
     `(org-level-6          ((t (,@variable-tuple :weight bold))))
     `(org-level-7          ((t (,@variable-tuple :weight bold))))
     `(org-level-8          ((t (,@variable-tuple :weight bold))))
     `(org-document-title   ((t (,@variable-tuple :weight bold :height 2.0 :underline nil))))

     ;; Set code-related faces to use the code font (PragmataPro Mono Liga)
     `(org-block            ((t (,@code-font))))
     `(org-block-begin-line ((t (,@code-font))))
     `(org-block-end-line   ((t (,@code-font))))
     `(org-code             ((t (,@code-font))))
     `(org-verbatim         ((t (,@code-font))))))  ; handles ~code~ and =verbatim=
